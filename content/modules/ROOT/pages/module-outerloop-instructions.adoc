...
git init
git remote add origin {gitea_console_url}/{user_name}/inventory-quarkus.git
git add *
git commit -m "Initial"
git push http://{user_name}:openshift@gitea-server.gitea.svc:3000/{user_name}/inventory-quarkus.git
----
...
To {gitea_console_url}/{user_name}/inventory-quarkus.git
 * [new branch]      master -> master
----

Once done, in your {GIT_URL}/{user_name}/inventory-quarkus[Git Repository^, role='params-link'], *refresh the page of your inventory-quarkus repository*`. You should see the project files in the repository.
