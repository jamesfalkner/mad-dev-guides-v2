...
[NOTE]
====
In case you don't see the previous analysis report when you click on *Open Report*, refresh the browser where you run the VS Code. Open the report again.

image::eap/reopen-report.png[MTA Add App, 400]
====
