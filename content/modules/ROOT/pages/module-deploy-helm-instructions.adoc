...
image::deploy-helm/kc_login.png[]
...
image::deploy-helm/quarkus_todo_app_added_todo.png[]
...
image::deploy-helm/quarkus_helm_upgraded.png[]
...
image::deploy-helm/quarkus_helm_upgraded_healthchecks_details.png[]
