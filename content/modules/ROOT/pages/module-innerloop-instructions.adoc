...
Congratulations! You are now ready to move on to the next lab.

== Summary

You have completed the [Inner Loop](https://github.com/rh-mad-workshop/mad-dev-guides-v2/blob/main/mad-dev-guides-v2/content/modules/ROOT/pages/module-innerloop.adoc) module.
