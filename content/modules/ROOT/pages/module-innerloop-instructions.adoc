...
[#what_is_openshift_devspaces]
=== 1.1 What is Red Hat OpenShift Dev Spaces?
...
=== 1.2 Getting your Developer Workspace with a single click

https://access.redhat.com/products/red-hat-openshift-dev-spaces[OpenShift Dev Spaces^]  will provide you an out-of-the-box *Developer Workspace* with all the tools and the dependencies we need to do the job. **And with only one single click!**
...
[window=_blank, align="center"]
[role='params-link']
image::innerloop/developer-workspace-button.svg[Developer Workspace - Button, 300]

Then `*Click 'Log in with OpenShift'*`

image::innerloop/login-with-openshift.png[OpenShift - Login, 500]

Then `*login as user{USER_ID}/{OPENSHIFT_PASSWORD}*.`

image::innerloop/che-login.png[Che - Login, 500]
...
[#login_to_openshift]
=== 1.4 Log in to the OpenShift Developer Console
...
[window=_blank, align="center"]
[role='params-link']
image::innerloop/developer-console-button.png[Developer Workspace - Button, 300]
...
image::innerloop/openshift-empty-project.png[OpenShift - Empty Project, 700]
...
[sidebar]
--
image::innerloop/quarkus-logo.png[Quarkus, 500]
...
image::innerloop/inventory-quarkus-project.png[Inventory Project,500]
...
image::innerloop/che-open-8080-link.png[Che - Open Link, 500]

You then have to confirm the access to external web sites:

image::innerloop/vscode-external-website.png[Che - Open Link, 500]

Your browser will be directed to **your Inventory Service running inside your Workspace**.

image::innerloop/inventory-quarkus.png[Inventory Quarkus,500]
...
image::innerloop/openshift-inventory-topology.png[OpenShift - Inventory Topology, 700]
