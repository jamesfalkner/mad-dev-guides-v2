...
To get started, access https://developer-hub-backstage-rhdhub.{openshift_subdomain}[Red Hat Developer Hub UI^]
...
image::devhub/rhdevhub_menu.png[width=90%, float=left]  
...
** Go back to the https://developer-hub-backstage-rhdhub.{openshift_subdomain}[Red Hat Developer Hub UI^]
...
image::devhub/task_activity.png[width=100%]  
...
* Go back to your inventory component on the Red Hat Developer Hub: https://developer-hub-backstage-rhdhub.{openshift_subdomain}/catalog/default/component/inventory-app-{user_name}[Red Hat Developer Hub UI^].
...
* Go back to your catalog component on the Red Hat Developer Hub: https://developer-hub-backstage-rhdhub.{openshift_subdomain}/catalog/default/component/catalog-app-{user_name}[Red Hat Developer Hub UI^].
...
image::devhub/ui_web.png[width=100%]
...
=== 3.3.1. Go back to your frontend component on the Red Hat Developer Hub: https://developer-hub-backstage-rhdhub.{openshift_subdomain}/catalog/default/component/frontend-app-{user_name}[Red Hat Developer Hub UI^].
...
* Go back to your frontend component on the Red Hat Developer Hub: https://developer-hub-backstage-rhdhub.{openshift_subdomain}/catalog/default/component/frontend-app-{user_name}[Red Hat Developer Hub UI^].
