...
image::devhub/welcome.png[width=120%]
...
image::devhub/tech_radar.png[900] 
...
image::devhub/gitlab_st_details.png[800]  
...
image::devhub/rhdh_architecture.png[700]  
...
image::devhub/software_template_quarkus.png[700]  
...
image::devhub/st_gitlab_info.png[800]  
...
image::devhub/st_component_clusterid.png[800]  
...
image::devhub/st_component_namespace.png[800]  
...
image::devhub/st_component_owner.png[800]  
...
image::devhub/st_component_componentid_quarkus.png[800]  
...
image::devhub/st_component_review_quarkus.png[800]  
...
image::devhub/inventory_pipeline.png[900] 
...
image::devhub/inventory_deployment.png[900] 
...
image::devhub/software_templates_spring.png[800]  
...
image::devhub/st_gitlab_info.png[700]  
...
image::devhub/st_component_componentid_spring.png[800]  
...
image::devhub/st_component_review_spring.png[800]  
...
image::devhub/catalog_overview.png[900] 
...
image::devhub/overview_pipelines_click.png[700] 

Wait until the Pipeline is green. The Pipeline will take a few minutes to complete.

image::devhub/pipelines_openshift.png[700] 
...
image::devhub/overview_deployment_click.png[700] 
...
image::devhub/catalog_deployment.png[700] 
...
image::devhub/software_templates_gateway.png[800]  
...
image::devhub/st_component_clusterid.png[700]  
...
image::devhub/st_component_componentid_gateway.png[700]  
...
image::devhub/st_component_review_gateway.png[800]  
...
image::devhub/gateway_overview.png[900]  
...
image::devhub/gateway_pipelines.png[900] 
...
image::devhub/gateway_deployment.png[800] 
...
image::devhub/gateway_yourclusters.png[900] 

** Expand the pods information:

image::devhub/gateway_kubernetes_clusters_ok.png[900] 
...
image::devhub/software_templates_frontend.png[800]  
...
image::devhub/st_component_componentid_frontend.png[700]  
...
image::devhub/st_component_review_frontend.png[900]  
...
image::devhub/frontend_overview.png[900] 

* Click on *CI* to review your pipeline information.
The pipeline will be triggered in a few seconds. After a few minutes, you will see the pipeline finished as *Succeeded*.

image::devhub/frontend_pipeline.png[900] 
...
image::devhub/frontend_topology.png[900] 

* Click on *CD* to review ARGOCD History.

image::devhub/frontend_argohistory.png[900] 

* Click on *API* to review the consumed/provided API for the frontend application.

image::devhub/frontend_apiconsume.png[900] 
...
image::devhub/frontend_issues.png[900]

* Click on the *issue link* to read the information.

image::devhub/frontend_issue_desc.png[900]
...
image::devhub/devspaces_authorize.png[800]
...
image::devhub/gitlab_authentication.png[7 00]

=== 3.4.4 Authorize *devspaces* to use your account by clicking on the *Authorize* button.

image::devhub/devspaces_authorize_user.png[700]
...
image::devhub/devspaces_trustauthors.png[800]

** Click on *Mark Done*

image::devhub/devspaces_view.png[800]


=== 3.4.7 Expand the `frontend-app-{user_name}` to find for the file: `header.html` as shown in the picture below.

image::devhub/file_change.png[900]
...
image::devhub/dev_file_changed.png[800]
...
image::devhub/dev_confirmed.png[900]
