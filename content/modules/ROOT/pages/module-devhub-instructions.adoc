...
image::devhub/st_component_namespace.png[600]  
...
image::devhub/st_component_componentid_spring.png[900]  
...
image::devhub/gitlab_authentication.png[700]

=== 3.4.4 Authorize *devspaces* to use your account by clicking on the *Authorize* button.

image::devhub/devspaces_authorize_user.png[500]
