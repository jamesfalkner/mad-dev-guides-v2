...
== 1. Understand the Globex Retail System Architecture
...
=== 2.3. Red Hat OpenShift Dev Spaces

Red Hat OpenShift Dev Spacesis already deployed in the OpenShift cluster for you to use as your Cloud IDE. This means you don't need to install and configure anything on your system. This makes it easy to change source code and configuration files in the cloned repository.
